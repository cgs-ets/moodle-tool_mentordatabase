...
/**
 * CLI sync for full mentor database synchronisation.
 *
...
if ($options['help']) {
    $help = "Execute mentor sync with external database.
...
Example:
\$ sudo -u www-data /usr/bin/php admin/tool/mentordatabase/cli/sync.php
";
...
$result = $result | $mentordatabase->sync($trace);
